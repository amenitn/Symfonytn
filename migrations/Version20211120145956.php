 ...
 */
final class Version20211120145956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student ADD classroom_id INT NOT NULL, ADD nsc VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student DROP classroom_id, DROP nsc, DROP email');
    }
}
